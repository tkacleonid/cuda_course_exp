...
#define lhs_(i, m) lhs_[(m) * P_SIZE * P_SIZE * P_SIZE + (i) * P_SIZE * P_SIZE + (k) * P_SIZE + j]
#define lhsp_(i, m) lhsp_[(m) * P_SIZE * P_SIZE * P_SIZE + (i) * P_SIZE * P_SIZE + (k) * P_SIZE + j]
#define lhsm_(i, m) lhsm_[(m) * P_SIZE * P_SIZE * P_SIZE + (i) * P_SIZE * P_SIZE + (k) * P_SIZE + j]
